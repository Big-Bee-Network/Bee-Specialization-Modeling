...
# Change common catagory to 'not-rare' (assumption: fowler is exhustive) # DONE
...
library(dplyr)
library(ggplot2)
compare_df <- read.csv('/Users/nickbachelder/Desktop/Bee-Specialization-Modeling/modeling_data/compare_df.csv') %>% dplyr::select(-X)
