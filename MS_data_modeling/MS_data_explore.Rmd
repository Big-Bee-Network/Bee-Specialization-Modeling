...
MS_data <- readxl::read_xlsx('modeling_data/DATA_pollen-diet-breadth_list_12-5-21_ALR.xlsx', sheet = 2)

globee <- read_csv('modeling_data/BeeCiteRaw') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)

globee_5cut <- read_csv('modeling_data/BeeCiteC5') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)

globee_T <- read_csv('modeling_data/BeeCiteW') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)

fowler <- read.csv('modeling_data/fowler') %>%
...
globeeGenus <- read_csv('modeling_data/BeeCiteRawGenus') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)

globee_5cutGenus <- read_csv('modeling_data/BeeCiteC5Genus') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)

globee_TGenus <- read_csv('modeling_data/BeeCiteWGenus') %>%
  dplyr::select(-west_specialist, -east_specialist, -cent_specialist, -specialist)
```

```{r}
interactions <- read_csv('modeling_data/interactions_dup.csv')
...
final
write_csv(compare_df,'modeling_data/compare_df.csv')
write_csv(final, 'modeling_data/visitation_specialization_df')
```
